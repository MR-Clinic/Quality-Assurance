...
public class UpdateVisit {
    ...
    UpdateVisit updateVisit;
        ...
        @When("user update visit with input query params visit_uid {} with name of complaint {} with main diagnose penyakit sejuta umat yakni {} and additional diagnose {}  action {} recipe {} bloodPressuse {} heart rate {} saturated {} weight {}  height {} bmi {} status {}")
...
//                .statusCode(200);
        ...
        seeThatResponse("user success update visit status",
                response -> {
